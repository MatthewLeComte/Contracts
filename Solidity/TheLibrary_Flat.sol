...
@notice: The majority of this smart contract is comprised of imported contracts, scroll down to the main
         "TheLibrary.sol" smart contract to view relevant information about how this smart contract works.
         You can quickly find the smart contract by looking for the large "Smart Contract Start." in ASCII art.
         
         You can view this smart contract in its not flattened state on my GitHub. https://github.com/MatthewLeComte/
         Thank you for taking the time to look through this smart contract, I appreciate it.

         If you have any comments or concerns let me know through GitHub or Twitter.
         https://twitter.com/MatthewLeComte/
         https://github.com/MatthewLeComte/


         You can also contact me through my personal website:
         https://MatthewLeComte.com/
*/
